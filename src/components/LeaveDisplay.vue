...
export default {
    ...
    let allDocuments = await getDocs(collection(db,"Leave"), where("Type", "==", "Annual"))
    ...
    display()
    async function deleteLeave(duration) {
        alert("You are going to delete Leave " + duration)
        console.log(document.body.offsetWidth)
        await deleteDoc(doc(db,"Leave", duration))
        console.log("Document successfully deleted!", duration);
